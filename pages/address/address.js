...
Page({
  ...
  formSubmit: function (e) {
    ...
    var tuan_sn = this.data.tuan_sn;
    wx.request({
      url: app.d.anranUrl + '/index.php?m=default&c=indem&a=xcx_add_address',
      data: {
      ...
      success: function (res) {
        ...
        wx.redirectTo({
          url: 'user-address/user-address?cartId=' + cartId + '&g_id=' + g_id + '&tuanid=' + tuanid + '&tuan_sn=' + tuan_sn
        });
      },
      fail: function () {
        // fail
